...
{
    public class MyDictionary<Tkey, Tvalue> : IEnumerable<Tkey>, IEnumerator<Tkey>
    {
        public MyDictionary() { }
        ...
        Tkey IEnumerator<Tkey>.Current => (position >= 0 && position < size) ? _key[position] : default(Tkey);
